...
\par\noindent\makebox[2.5in]{\includegraphics[width=0.3\linewidth]{}}\hfill\makebox[2.0in]{November 2022}%
\par\noindent\makebox[2.5in]{\hrulefill} \hfill\makebox[2.0in]{\hrulefill}%
\par\noindent\makebox[2.5in][l]{Flourish Oluwamakinde}      \hfill\makebox[2.0in][l]{Date}%
